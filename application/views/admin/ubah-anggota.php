										...
										<form action="" method="post">
                                            <div class="form-row">
                                                    ...
                                                    <label class="text-dark font-weight-medium">Username</label>
                                                        ...
                                                        <input  type="text" class="form-control" name="username" value="<?=$anggota['username']?>" placeholder="Username" required>
                                                    </div>
                                                    ...
                                                    <label class="text-dark font-weight-medium mt-3">Email</label>
                                                        ...
                                                        <input  type="text" class="form-control" name="email" value="<?=$anggota['email']?>" placeholder="email" required>
                                                    </div>
