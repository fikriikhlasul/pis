...
{
    //get all notif
    public function getTotalNotifAnggota()
    {
        $table = [
        ...
        $this->db->where('user_profil_utama.tahun_masuk_univ', 'null');
        $this->db->where('user_profil_utama.alamat', 'null');
        $this->db->where('user_profil_predatech.no_anggota', 'null');
        $this->db->where('user_profil_predatech.puzzle', 'null');
        $this->db->where('user_profil_predatech.bidang_riset', 'null');
        $query = $this->db->get();         
    ...
    //Get array data untuk tampilan profil alumni
    public function getProfilAlumni()
    {
    $table = [
        'user.name',
        'user.tanggal_lahir',
    ...
    //Get array data untuk tampilan profil dosen
    public function getProfilDosen()
    {
    $table = [
        'user.name',
        'user.tanggal_lahir',
        ...
        'user_profil_dosen.no_hp'

    ];
    $this->db->select($table);
    $this->db->from('user'); 
    $this->db->join('user_profil_dosen', 'user_profil_dosen.username=user.username', 'left');
    $this->db->where('user_profil_dosen.username', $this->session->userdata('username'));
    $query = $this->db->get();         
    return $query->row_array();
    }
